...
var tests = [ "access-binary-trees", "bitops-3bit-bits-in-byte", "bitops-bitwise-and", "bitops-nsieve-bits", "controlflow-recursive" ];

//var categories = [ "3d", "access", "bitops", "controlflow", "crypto", "date", "math", "regexp", "string" ];
var categories = [ "access", "bitops", "controlflow" ];
